...
#0.3        Jan 23th,2017   Shubham    Working Version
...
class demoMainClass(QtGui.QMainWindow,Ui_MainWindow):
    ...
    def demoFunction(self):
        x1=float(self.X1.text()) #x1 value
        x2=float(self.X2.text()) #x2 value
        x3=float(self.X3.text()) #x3 value
        y1=float(self.Y1.text()) #y1 value 
        y2=float(self.Y2.text()) #y2 value
        y3=float(self.Y3.text()) #y3 value
        r1=float(self.R1.text()) #r1 value
        r2=float(self.R2.text()) #r2 value
        r3=float(self.R3.text()) #r3 value

        #Start of Triangulation code
